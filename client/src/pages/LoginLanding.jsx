...
const LoginLanding = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      <LoginLeftSide/>
      <div className="flex items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        {/* Footer */}
        <div className=" mt-12 text-centre md:text-left text-sm text-slate-400">
            <p>{new Date().getFullYear()} Harshit. All right reserved.</p>
        </div>
